    ...
    for ($i=0; $i<$number; $i++) {
      include 'generate_id_obat.php';
       if (trim($_POST["name"][$i] != '')) {
          $query_obat_lokal = oci_parse($conn_lokal, "INSERT INTO obat_keluar (id_obat_keluar, tgl_keluar, id_daftar, id_obat, jumlah) VALUES (:id_obat_keluar, to_date(:tgl_keluar, 'YYYY-MM-DD'), :id_daftar, :id_obat, :jumlah)");
          oci_bind_by_name($query_obat_lokal, ":id_obat_keluar", $id_obat_keluar);
          ...
          $query_obat_pusat = oci_parse($conn_pusat, "INSERT INTO obat_keluar (id_obat_keluar, tgl_keluar, id_daftar, id_obat, jumlah) VALUES (:id_obat_keluar, to_date(:tgl_keluar, 'YYYY-MM-DD'), :id_daftar, :id_obat, :jumlah)");
          oci_bind_by_name($query_obat_pusat, ":id_obat_keluar", $id_obat_keluar);
